...
const ProductCard = ({product}) => {
  ...
  return (
    <div className='w-[72%]  md:w-[40%] lg:w-[22%] border-2 p-5 flex flex-col gap-2 justify-center'>
        ...
        <div className='h-[100px]text-center text-xl font-bold'>{product?.price}$</div>
