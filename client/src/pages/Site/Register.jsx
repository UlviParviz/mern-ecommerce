    ...
    <div className='flex items-center justify-center py-[35%] md:py-[25%] lg:py-[10%]'>
        <div className='w-[93%] md:w-[72%] lg:w-[43%] flex flex-col justify-center gap-8 border-2 border-red-500 py-12 px-3 md:px-6 rounded-lg'>
            ...
            <div className='flex flex-col gap-2'> 
                    ...
                    <input name='name' value={name} onChange={onChange} className='rounded-lg' type="text" />
                </div>
                <div className='flex flex-col gap-2'> 
                    <label htmlFor="">Email</label>
                    <input name='email' value={email} onChange={onChange} className='rounded-lg' type="text" />
                </div>
                <div className='flex flex-col gap-2'> 
                    <label htmlFor="">Password</label>
                    <input name='password' value={password} onChange={onChange} className='rounded-lg' type="password" />
                </div>
      ...
      <span className="relative z-10">{isLoading ? "..." : "Sign Up"}</span>
    </button>
            </form>
            <div className='flex justify-between items-center'><span >Do you have an account?</span>
            <span onClick={() => navigate("/login")} className='hover:text-red-500 cursor-pointer'>Sign In</span> </div>
        </div>
    </div>
  )
}
